...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    private static final int MACHINE_IDENTIFIER =0;
    private static final short PROCESS_IDENTIFIER =0;
...
//    }
    ...
    private static int createMachineIdentifier() {
        ...
        try {
            ...
            log.debug("Failed to get machine identifier from network interface, using SecureRandom instead");
        }
    ...
    private static short createProcessIdentifier() {
        ...
        try {
            ...
            log.debug("Failed to get process identifier from JMX, using SecureRandom instead");
        }
    ...
    public static void main(String[] args){
        System.out.println(createMachineIdentifier());
