...
public class FileResolveModel {
	...
	public static void main(String[] args)
		...
		FileResolveModel model1 = new FileResolveModel();
		model1.setOrgId("103");
		...
		FileResolveModel model2 = ToObjectBuilder.toObject(content, FileResolveModel.class, "\t",
				System.lineSeparator());
		System.out.println(JSON.toJSONString(model2));

		FileResolveModel model3 = ToObjectBuilder.toObject(content, FileResolveModel.class, "\t",
				System.lineSeparator());
