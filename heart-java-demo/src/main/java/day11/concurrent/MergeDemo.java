...
/**
 * MergeExample is a class that runs a demo benchmark of the {@code ForkJoin}
 * framework by benchmarking a {@link MergeSort} algorithm that is implemented
 * using {@link java.util.concurrent.RecursiveAction}. The {@code ForkJoin}
 * framework is setup with different parallelism levels and the sort is executed
 * with arrays of different sizes to see the trade offs by using multiple
 * threads for different sizes of the array.
 */
public class MergeDemo {
	...
	/**
	 * Represents the formula {@code f(n) = start + (step * n)} for n = 0 & n <
	 * iterations
	 */
	private static class Range {
		 ...
		 * 
		 * @param args
		 *            the string array containing the arguments
		 * @param start
		 *            which element to start the start argument from
	 ...
	 * {@code sizes} represents the different array sizes {@code parallelism}
	 * represents the different parallelism levels
	 */
	private static class Configuration {
		...
		public static Configuration parse(String[] args) {
			if (args.length == 0) {
				...
				System.err.println(
						"example: will run with arrays of sizes 20000, 30000, 40000" + " and parallelism: 1, 2, 3, 4");
				return null;
			}
		}
		 ...
		 * 
		 * @return an array containing {@code sizes.iterations * parallelism.iterations}
		 *         elements
		 */
	 ...
	 * 
	 * @param elements
	 *            the number of elements requested in the array
	 ...
	 * 
	 * @param config
	 *            contains the settings for the test
	 */
	 ...
	 * 
	 * @param sizes
	 *            the different sizes of the arrays
	 * @param parallelism
	 *            the different parallelism levels used
	 * @param times
	 *            the median times for the different sizes / parallelism
	 */
	...
	/**
	 * Runs <i>iterations</i> number of test sorts of a random array of
	 * <i>element</i> length
	 * 
	 * @param iterations
	 ...
	 * @param parallelism
	 *            parallelism for the ForkJoin framework
